...
goods["XOre"]           = {name="Ore",              plural="Ore",               description="Raw metal-bearing stone.", icon="data/textures/icons/rock.png", mesh="data/meshes/trading-goods/silicon.obj", price=1, size=0.04, level=0, importance=1, illegal=false, dangerous=false, tags={basic=true}, chains={basic=true,consumer=true,industrial=true,military=true,technology=true}, }
goods["XScrapMetal"]    = {name="Scrap Metal",      plural="Scrap Metal",       description="Please recycle!",          icon="data/textures/icons/scrap-metal.png", mesh="data/meshes/trading-goods/silicon.obj", price=1, size=0.04, level=0, importance=1, illegal=false, dangerous=false, tags={basic=true}, chains={basic=true,consumer=true,industrial=true,military=true,technology=true}, }
goods["XUraniumOre"]    = {name="Ore (Uranium)",    plural="Ore (Uranium)",     description="Needs refining.",          icon="data/textures/icons/rock.png", mesh="data/meshes/trading-goods/silicon.obj", price=1, size=0.04, level=0, importance=1, illegal=false, dangerous=false, tags={basic=true}, chains={basic=true,consumer=true,industrial=true,military=true,technology=true}, }


goods["XScrapIron"]     = {name="Scrap (Iron)",     plural="Scrap (Iron)",        description="Scrap Iron that can be refined into Iron.", icon="data/textures/icons/scrap-metal.png", mesh="", price=4, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,iron=true,scrap=true}, chains={}, }
goods["XScrapTitanium"] = {name="Scrap (Titanium)", plural="Scrap (Titanium)",    description="Scrap Titanium that can be refined into Titanium.", icon="data/textures/icons/scrap-metal.png", mesh="", price=5, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,scrap=true,titanium=true}, chains={}, }
goods["XScrapNaonite"]  = {name="Scrap (Naonite)",  plural="Scrap (Naonite)",     description="Scrap Naonite that can be refined into Naonite.", icon="data/textures/icons/scrap-metal.png", mesh="", price=7, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,naonite=true,scrap=true}, chains={}, }
goods["XScrapTrinium"]  = {name="Scrap (Trinium)",  plural="Scrap (Trinium)",     description="Scrap Trinium that can be refined into Trinium.", icon="data/textures/icons/scrap-metal.png", mesh="", price=10, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,scrap=true,trinium=true}, chains={}, }
goods["XScrapXanion"]   = {name="Scrap (Xanion)",   plural="Scrap (Xanion)",      description="Scrap Xanion that can be refined into Xanion.", icon="data/textures/icons/scrap-metal.png", mesh="", price=13, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,scrap=true,xanion=true}, chains={}, }
goods["XScrapOgonite"]  = {name="Scrap (Ogonite)",  plural="Scrap (Ogonite)",     description="Scrap Ogonite that can be refined into Ogonite.", icon="data/textures/icons/scrap-metal.png", mesh="", price=18, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ogonite=true,scrap=true}, chains={}, }
goods["XScrapAvorion"]  = {name="Scrap (Avorion)",  plural="Scrap (Avorion)",     description="Scrap Avorion that can be refined into Avorion.", icon="data/textures/icons/scrap-metal.png", mesh="", price=24, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={avorion=true,basic=true,scrap=true}, chains={}, }

goods["XIronOre"]       = {name="Ore (Iron)",       plural="Ore (Iron)",        description="Iron ore that can be refined into Iron.", icon="data/textures/icons/rock.png", mesh="", price=2, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,iron=true,ore=true}, chains={}, }
goods["XTitaniumOre"]   = {name="Ore (Titanium)",   plural="Ore (Titanium)",    description="Titanium ore that can be refined into Titanium.", icon="data/textures/icons/rock.png", mesh="", price=3, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,titanium=true}, chains={}, }
goods["XNaoniteOre"]    = {name="Ore (Naonite)",    plural="Ore (Naonite)",     description="Naonite ore that can be refined into Naonite.", icon="data/textures/icons/rock.png", mesh="", price=4, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,naonite=true,ore=true}, chains={}, }
goods["XTriniumOre"]    = {name="Ore (Trinium)",    plural="Ore (Trinium)",     description="Trinium ore that can be refined into Trinium.", icon="data/textures/icons/rock.png", mesh="", price=5, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,trinium=true}, chains={}, }
goods["XXanionOre"]     = {name="Ore (Xanion)",     plural="Ore (Xanion)",      description="Xanion ore that can be refined into Xanion.", icon="data/textures/icons/rock.png", mesh="", price=7, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,xanion=true}, chains={}, }
goods["XOgoniteOre"]    = {name="Ore (Ogonite)",    plural="Ore (Ogonite)",     description="Ogonite ore that can be refined into Ogonite.", icon="data/textures/icons/rock.png", mesh="", price=9, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ogonite=true,ore=true}, chains={}, }
goods["XAvorionOre"]    = {name="Ore (Avorion)",    plural="Ore (Avorion)",     description="Avorion ore that can be refined into Avorion.", icon="data/textures/icons/rock.png", mesh="", price=12, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={avorion=true,basic=true,ore=true}, chains={}, }




-- Avorion needs these not to crash
-- (crashes on first galaxy generation after starting the program, but succeeds on subsequent?)

goods["Rift Avorion Ore"] = {name="Rift Avorion Ore", plural="Rift Avorion Ore", description="Very rich Avorion ore that can only be found in rifts. Can be refined into Avorion. Yields 4x as much as normal Avorion Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=12, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={avorion=true,basic=true,ore=true,rich=true}, chains={}, }
goods["Rift Iron Ore"] = {name="Rift Iron Ore", plural="Rift Iron Ore", description="Very rich Iron ore that can only be found in rifts. Can be refined into Iron. Yields 4x as much as normal Iron Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=2, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,iron=true,ore=true,rich=true}, chains={}, }
goods["Rift Naonite Ore"] = {name="Rift Naonite Ore", plural="Rift Naonite Ore", description="Very rich Naonite ore that can only be found in rifts. Can be refined into Naonite. Yields 4x as much as normal Naonite Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=4, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,naonite=true,ore=true,rich=true}, chains={}, }
goods["Rift Ogonite Ore"] = {name="Rift Ogonite Ore", plural="Rift Ogonite Ore", description="Very rich Ogonite ore that can only be found in rifts. Can be refined into Ogonite. Yields 4x as much as normal Ogonite Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=9, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ogonite=true,ore=true,rich=true}, chains={}, }
goods["Rift Research Data"] = {name="Rift Research Data", plural="Rift Research Data", description="A memory device with valuable research data about subspace rifts. Can be traded for equipment or sold for money at a Rift Research Center.", icon="data/textures/icons/info-chip.png", mesh="data/meshes/trading-goods/crate-food.obj", price=5000, size=0.5, level=nil, importance=0, illegal=false, dangerous=false, tags={mission_relevant=true,rare=true,technology=true}, chains={}, }
goods["Rift Titanium Ore"] = {name="Rift Titanium Ore", plural="Rift Titanium Ore", description="Very rich Titanium ore that can only be found in rifts. Can be refined into Titanium. Yields 4x as much as normal Titanium Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=3, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,rich=true,titanium=true}, chains={}, }
goods["Rift Trinium Ore"] = {name="Rift Trinium Ore", plural="Rift Trinium Ore", description="Very rich Trinium ore that can only be found in rifts. Can be refined into Trinium. Yields 4x as much as normal Trinium Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=5, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,rich=true,trinium=true}, chains={}, }
goods["Rift Xanion Ore"] = {name="Rift Xanion Ore", plural="Rift Xanion Ore", description="Very rich Xanion ore that can only be found in rifts. Can be refined into Xanion. Yields 4x as much as normal Xanion Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=7, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,rich=true,xanion=true}, chains={}, }
...
goods["Scrap Trinium"] = {name="Scrap Trinium", plural="Scrap Trinium", description="Scrap Trinium that can be refined into Trinium.", icon="data/textures/icons/scrap-metal.png", mesh="", price=10, size=0.04, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,scrap=true,trinium=true}, chains={}, }
...
goods["Titanium Ore"] = {name="Titanium Ore", plural="Titanium Ore", description="Titanium ore that can be refined into Titanium.", icon="data/textures/icons/rock.png", mesh="", price=3, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,titanium=true}, chains={}, }
goods["Trinium Ore"] = {name="Trinium Ore", plural="Trinium Ore", description="Trinium ore that can be refined into Trinium.", icon="data/textures/icons/rock.png", mesh="", price=5, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,trinium=true}, chains={}, }
goods["Xanion Ore"] = {name="Xanion Ore", plural="Xanion Ore", description="Xanion ore that can be refined into Xanion.", icon="data/textures/icons/rock.png", mesh="", price=7, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ore=true,xanion=true}, chains={}, }
goods["Avorion Ore"] = {name="Avorion Ore", plural="Avorion Ore", description="Avorion ore that can be refined into Avorion.", icon="data/textures/icons/rock.png", mesh="", price=12, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={avorion=true,basic=true,ore=true}, chains={}, }
goods["Iron Ore"] = {name="Iron Ore", plural="Iron Ore", description="Iron ore that can be refined into Iron.", icon="data/textures/icons/rock.png", mesh="", price=2, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,iron=true,ore=true}, chains={}, }
goods["Naonite Ore"] = {name="Naonite Ore", plural="Naonite Ore", description="Naonite ore that can be refined into Naonite.", icon="data/textures/icons/rock.png", mesh="", price=4, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,naonite=true,ore=true}, chains={}, }
goods["Ogonite Ore"] = {name="Ogonite Ore", plural="Ogonite Ore", description="Ogonite ore that can be refined into Ogonite.", icon="data/textures/icons/rock.png", mesh="", price=9, size=0.025, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,ogonite=true,ore=true}, chains={}, }
...
-- These have to appear exactly otherwise Avorion crashes
--[[
goods["Rift Avorion Ore"] = {name="Rift Avorion Ore", plural="Rift Avorion Ore", description="Very rich Avorion ore that can only be found in rifts. Can be refined into Avorion. Yields 4x as much as normal Avorion Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=12, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={avorion=true,basic=true,ore=true,rich=true}, chains={}, }
goods["Rift Iron Ore"] = {name="Rift Iron Ore", plural="Rift Iron Ore", description="Very rich Iron ore that can only be found in rifts. Can be refined into Iron. Yields 4x as much as normal Iron Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=2, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,iron=true,ore=true,rich=true}, chains={}, }
goods["Rift Naonite Ore"] = {name="Rift Naonite Ore", plural="Rift Naonite Ore", description="Very rich Naonite ore that can only be found in rifts. Can be refined into Naonite. Yields 4x as much as normal Naonite Ore.", icon="data/textures/icons/rift-rock.png", mesh="", price=4, size=0.05, level=nil, importance=0, illegal=false, dangerous=false, tags={basic=true,naonite=true,ore=true,rich=true}, chains={}, }
