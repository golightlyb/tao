...
meta =
{
    ...
    name = "Asteroids Load 2 Percent Faster",

    -- Title of your mod that will be displayed to players
    title = "Asteroids Load 2 Percent Faster",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Super optimised code to make Asteroids load a modest 1.7% faster. Part of my work in progress overhaul at https://github.com/golightlyb/tao",

    -- Insert all authors into this list
    authors = {"Sarah a.k.a hoboben"},
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "2.3.1", max = "2.3.1"}
    },
    ...
    contact = "https://github.com/golightlyb/tao",
}
